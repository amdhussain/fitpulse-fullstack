...
//     .trim()
//     .isString()
//     .withMessage('Phone must be a valid text/number string'),
...
const updateProfile = [
  ...
  body('phone')
    ...
    .isString()
    .withMessage('Phone must be a valid text/number string'),
  // rules.optionalUrl('profileImage'), // <-- এই লাইনটি এখান থেকে তুলে দেওয়া হলো
];
...
const updateAdminProfile = [
  ...
  body('lastName')
    ...
    .isString()
    .withMessage('Last name must be a string'),
  // rules.optionalUrl('profileImage'), // <-- এখান থেকেও তুলে দেওয়া হলো
];
