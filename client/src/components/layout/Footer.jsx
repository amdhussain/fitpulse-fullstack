...
function Footer() {
  ...
  return (
    <footer className="bg-gray-50 dark:bg-slate-900 border-t border-gray-200 dark:border-white/10">
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-9 h-9 rounded-lg bg-gray-200 dark:bg-white/10 flex items-center justify-center
                    text-gray-500 dark:text-gray-400 hover:bg-blue-500 hover:text-white
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-sm text-gray-500 dark:text-gray-400">
                <FiMapPin className="mt-0.5 shrink-0 text-blue-600" size={16} />
              ...
              <li className="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
                <FiPhone className="shrink-0 text-blue-600 dark:text-blue-400" size={16} />
                <span>+1 (555) 123-4567</span>
              </li>
              <li className="flex items-center gap-3 text-sm text-gray-500 dark:text-gray-400">
                <FiMail className="shrink-0 text-blue-600 dark:text-blue-400" size={16} />
        ...
        <Container className="py-5">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-gray-400 dark:text-gray-500">
            ...
            <div className="flex gap-4">
              <span className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors cursor-pointer">Privacy Policy</span>
              <span className="hover:text-blue-600 dark:hover:text-blue-400 transition-colors cursor-pointer">Terms of Service</span>
            </div>
          </div>
        </Container>
      </div>
