...
function AdminProfile() {
  ...
  const userInitial = form.firstName?.charAt(0)?.toUpperCase() || "A";
    ...
    return (
      <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 rounded-2xl bg-white dark:bg-gray-800 border border-indigo-100 dark:border-indigo-800/50 p-6 space-y-6">
            <div className="h-5 w-32 rounded-lg bg-indigo-100 dark:bg-indigo-900/50 animate-pulse" />
            <div className="w-28 h-28 rounded-2xl bg-indigo-50 dark:bg-indigo-900/30 animate-pulse" />
  ...
  return (
    <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="space-y-6">
      <PageBanner pageKey="admin-profile" subtitle="Manage your admin profile and account settings" />

      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard icon={FiAward} label="Role" value="Administrator" pageKey="admin-profile" index={0} />
        <StatCard icon={FiCalendar} label="Member Since" value={memberSince} pageKey="admin-profile" index={1} />
        <StatCard icon={FiActivity} label="Last Active" value="Just now" pageKey="admin-profile" index={2} />
        <StatCard icon={FiCheckCircle} label="Account Status" value="Active" pageKey="admin-profile" index={3} />
      </div>
          ...
          <div className="rounded-2xl bg-white dark:bg-gray-800 backdrop-blur-xl border border-indigo-100 dark:border-indigo-800/50 overflow-hidden">
            <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Your admin profile details</p>
              </div>
              <Button
                variant="indigo"
                size="sm"
            ...
            <form onSubmit={handleProfileSubmit} className="p-6 space-y-6">
              <div className="flex flex-col sm:flex-row items-center gap-6 pb-6 border-b border-gray-100 dark:border-gray-700">
                <div className="relative shrink-0">
                  <div className="w-28 h-28 rounded-2xl overflow-hidden border-2 border-indigo-200 dark:border-indigo-700">
                    {form.profileImage ? (
                      <img src={form.profileImage} alt={fullName} className="w-full h-full object-cover" />
                    ) : (
              ...
              <div>
                <label className="block text-sm font-medium text-gray-500 dark:text-gray-400 mb-1.5">
                  <FiCamera className="w-3.5 h-3.5 inline mr-1.5" />
                  Profile Image URL
                </label>
                <input
                  type="url"
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{memberSince}</p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-xl bg-indigo-50 dark:bg-indigo-900/30 flex items-center justify-center">
