...
import {
  FiSave, FiUser, FiMail, FiLock, FiShield, FiCamera,
} from "react-icons/fi";
...
function AdminSettings() {
    ...
    return (
      <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="space-y-6">
        ...
        <div className="rounded-2xl bg-white dark:bg-gray-800 border border-indigo-100 dark:border-indigo-800/50 p-6 space-y-6">
          ...
          <div className="h-28 w-28 rounded-2xl bg-indigo-50 dark:bg-indigo-900/30 animate-pulse" />
  ...
  return (
    <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="space-y-6">
      <PageBanner pageKey="admin-settings" subtitle="Manage your admin account settings" />
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="rounded-2xl bg-white dark:bg-gray-800 backdrop-blur-xl border border-indigo-100 dark:border-indigo-800/50 overflow-hidden">
            <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-700">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Update your name and profile image</p>
            </div>
          ...
          <div className="rounded-2xl bg-white dark:bg-gray-800 backdrop-blur-xl border border-indigo-100 dark:border-indigo-800/50 overflow-hidden">
            <div className="px-6 py-5 border-b border-gray-100 dark:border-gray-700">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage your email and password</p>
            </div>
      ...
      <CmsModal
        ...
        onClose={() => { setShowEmailModal(false); setEmailForm({ newEmail: "", password: "" }); setEmailError(""); }}
        title="Change Email"
        subtitle="Update your admin email address"
        size="md"
      >
        <form onSubmit={handleEmailSubmit} className="space-y-5">
          ...
          <div className="flex items-center gap-3 pt-4 border-t border-gray-100 dark:border-gray-700">
            ...
            <Button type="button" variant="ghost" size="md" onClick={() => { setShowEmailModal(false); setEmailForm({ newEmail: "", password: "" }); setEmailError(""); }}>
              Cancel
            </Button>
      ...
      <CmsModal
        ...
        onClose={() => { setShowPasswordModal(false); setPasswordForm({ currentPassword: "", newPassword: "", confirm: "" }); setPasswordError(""); }}
      ...
      >
        <form onSubmit={handlePasswordSubmit} className="space-y-5">
          ...
          <div className="flex items-center gap-3 pt-4 border-t border-gray-100 dark:border-gray-700">
            ...
            <Button type="button" variant="ghost" size="md" onClick={() => { setShowPasswordModal(false); setPasswordForm({ currentPassword: "", newPassword: "", confirm: "" }); setPasswordError(""); }}>
              Cancel
            </Button>
